...
static sc_boolean usi_twi_peripheral_check_main_region_initialized_inner_region_active_inner_region_writing_to_master_r1__choice_0_tr1_tr1(const Usi_twi_peripheral* handle);
static sc_boolean usi_twi_peripheral_check_main_region_initialized_inner_region_active_inner_region_writing_to_master_r1__choice_0_tr0(const Usi_twi_peripheral* handle);
...
static void usi_twi_peripheral_exseq_main_region_initialized_inner_region_active_inner_region_writing_to_master(Usi_twi_peripheral* handle);
...
static void usi_twi_peripheral_effect_main_region_initialized_inner_region_active_inner_region_writing_to_master_r1__choice_0_tr0(Usi_twi_peripheral* handle)
{
	usi_twi_peripheral_exseq_main_region_initialized_inner_region_active_inner_region_writing_to_master(handle);
}
...
/* Default exit sequence for state writing_to_master */
static void usi_twi_peripheral_exseq_main_region_initialized_inner_region_active_inner_region_writing_to_master(Usi_twi_peripheral* handle)
{
	/* Default exit sequence for state writing_to_master */
	usi_twi_peripheral_exseq_main_region_initialized_inner_region_active_inner_region_writing_to_master_r1(handle);
}
...
{
	/* The reactions of state null. */
	if (usi_twi_peripheral_check_main_region_initialized_inner_region_active_inner_region_writing_to_master_r1__choice_0_tr1_tr1(handle) == bool_true)
	{ 
