...
typedef enum
{
	...
	Usi_twi_peripheral_main_region_initialized_r0_active_r0_reading_from_master_network_no_command,
	Usi_twi_peripheral_main_region_initialized_r0_active_r0_reading_from_master_network_command_accepted,
